...
export class WelcomeService implements IWelcomeService {
    public async getSession(): Promise<string> {
        ...
        const sessionResponse: SessionResponse = await response.json() as SessionResponse;
    ...
    public async getWelcome(): Promise<string> {
        ...
        const welcomeResponse: WelcomeResponse = await response.json() as WelcomeResponse;
    ...
    public async getSecret(): Promise<string> {
        ...
        const secretResponse: SecretResponse = await response.json() as SecretResponse;
